        ...
        const getAllStudent = () =>{
          ...
          const updateAll = ()=>{
            ...
            const deleteStudent = async () => {
              try {
                const res = await axios.delete(`http://localhost:8080/api/etudiant/delete/${studentID}`,{id:studentID});
            ...
            const validateStudent = (id)=>{
              const url = `http://localhost:8080/api/etudiant/validate/${studentID}`
              axios.put(url, {id:studentID}).then((res)=>{
                getAllStudent()
                getStudent()
                setError("")
              }).catch(err => {

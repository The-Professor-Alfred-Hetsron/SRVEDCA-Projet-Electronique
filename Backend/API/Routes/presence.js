...
router.post('/', PresenceController.getPresences) //J'ajoute cette ligne parce que l'ESP32 ne peut pas faire de GET ayant un body. Il fera donc un POST à la place
